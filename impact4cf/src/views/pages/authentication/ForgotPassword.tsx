            ...
            <Grid sx={{ m: { xs: 1, sm: 3 }, mb: 0 }}>
              ...
              <AuthCardWrapper>
                <Grid container spacing={2} sx={{ alignItems: 'center', justifyContent: 'center' }}>
                  <Grid sx={{ mb: 0 }}>
                    <Link href="#" aria-label="theme logo" sx={{ textDecoration: 'none' }}>
                      <Typography gutterBottom variant="h1" sx={{ color: 'secondary.main' }}>
                        ImpACT4CF
                      </Typography>
                    </Link>
                  </Grid>
                    ...
                    <Grid container spacing={2} sx={{ alignItems: 'center', justifyContent: 'center', textAlign: 'center' }}>
                      ...
                      <Grid size={12}>
                        <Typography variant="caption" sx={{ fontSize: '16px', textAlign: 'center' }}>
                          Send a message to the following email to get in touch.
                          <br />
                          <br />
                          <Typography
                            variant="caption"
                            component="a"
                            href="mailto:gregsaul@gmail.com"
                            sx={{ 
                              textDecoration: 'none', 
                              color: 'inherit', 
                              fontSize: '16px', 
