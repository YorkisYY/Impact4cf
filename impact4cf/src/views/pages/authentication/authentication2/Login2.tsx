                  ...
                  <Grid container spacing={2} sx={{ justifyContent: 'center' }}>
                    ...
                    <Grid size={12}>
                      <Grid container direction="column" sx={{ alignItems: 'center' }} size={12}>
                        <Typography component={Link} href="/pages/register/register2" variant="subtitle1" sx={{ textDecoration: 'none' }}>
            ...
            <Grid container sx={{ justifyContent: 'center' }}>
              ...
              <Grid sx={{ position: 'relative' }} size={12}>
                <CardMedia
                  ...
                  src={imgMain}
                  alt="Auth method"
                  sx={{ position: 'relative', zIndex: 5, maxWidth: 1, margin: '0 auto', display: 'block', width: 300 }}
                />
              </Grid>
            </Grid>
          </BackgroundPattern2>
