...
export default function NavCollapse({ menu, level, parentId }: NavCollapseProps) {
  ...
  const iconSelectedColor = mode === ThemeMode.DARK && drawerOpen ? 'text.primary' : 'common.white';
              ...
              ...(drawerOpen &&
                ...
                mode !== ThemeMode.DARK && {
                  ...
                  '&.Mui-selected': {
                    ...
                    '&:hover': { color: iconSelectedColor, bgcolor: '.primary.dark' }
                  }
                }),
              ...((!drawerOpen || level !== 1) && {
                py: level === 1 ? 0 : 1,
                ...
                sx={{
                  ...
                  ...(!drawerOpen &&
                    level === 1 && {
                      ...
                      '&:hover': {
                        bgcolor: mode === ThemeMode.DARK ? alpha(theme.palette.primary.dark, 0.35) : 'primary.dark',
                        color: 'common.white'  // Make icon white on hover when collapsed
                      },
                      ...(isSelected && {
                        bgcolor: mode === ThemeMode.DARK ? alpha(theme.palette.primary.dark, 0.35) : 'primary.dark',
                ...
                <List
                  ...
                  sx={{
                    ...
                    '&:after': {
                      ...
                      bgcolor: mode === ThemeMode.DARK ? 'dark.light' : 'primary.dark'
                    }
                  }}
                >
                  {menus}
