...
export const Auth0Provider = ({ children }: { children: React.ReactElement }) => {
  ...
  const loginAuth = async (options?: KeyedObject) => {
  ...
  return <Auth0Context.Provider value={{ ...state, loginAuth, logout, resetPassword, updateProfile }}>{children}</Auth0Context.Provider>;
};
